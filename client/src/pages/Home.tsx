    ...
    <div className="site-shell">
      <header className={`site-nav ${scrolled ? "site-nav--scrolled" : ""}`}>
        ...
        <div className="nav-actions">
          <button className="archive-trigger" onClick={() => scrollToId("ask")}>Ask the archive <ArrowUpRight size={15} /></button>
        ...
        {menuOpen && <nav className="mobile-menu" aria-label="Mobile navigation">
          ...
          <button onClick={() => { scrollToId("ask"); setMenuOpen(false); }}>Ask the archive <ArrowUpRight size={15} /></button>
        </nav>}
      </header>
